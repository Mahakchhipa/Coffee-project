      ...
      >
        ...
        <div className="hidden lg:flex lg:flex-1 lg:justify-end">
          <a href="#" className="text-lg font-semibold text-gray-900">
            <ShoppingBagIcon
              width={50}
              className=" bg-gray-100 text-black font-bold shadow-xl hover:bg-gray-300 hover:shadow-2xl shadow-gray-400 rounded-full  p-2 hover:scale-125 hover:cursor-pointer transition-all"
            />
          </a>
        </div>
        <div>
